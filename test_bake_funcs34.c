...
int main(int argc, char *argv[]){
  ...
  IF_TEST("bake_set_updates1") { 
    ...
    system("cp -r test_data34/bake_set_updates1 test-results/");
  ...
  IF_TEST("bake_set_updates2") { 
    ...
    system("cp -r test_data34/bake_set_updates2 test-results/");
  ...
  IF_TEST("bake_set_updates3") { 
    ...
    system("cp -r test_data34/bake_set_updates3 test-results/");
  ...
  IF_TEST("bake_set_updates4") { 
    ...
    system("cp -r test_data34/bake_set_updates4 test-results/");
  ...
  IF_TEST("bake_set_updates5") { 
    ...
    system("cp -r test_data34/bake_set_updates5 test-results/");
  ...
  IF_TEST("bake_set_updates6") { 
    ...
    system("cp -r test_data34/bake_set_updates6 test-results/");
  ...
  IF_TEST("bake_set_updates7") { 
    ...
    system("cp -r test_data34/bake_set_updates7 test-results/");
  ...
  IF_TEST("bake_do_updates1") { 
    ...
    system("cp -r test_data34/bake_do_updates1 test-results/");
  ...
  IF_TEST("bake_do_updates2") { 
    ...
    system("cp -r test_data34/bake_do_updates2 test-results/");
  ...
  IF_TEST("bake_do_updates3") { 
    ...
    system("cp -r test_data34/bake_do_updates3 test-results/");
  ...
  IF_TEST("bake_post_process1") { 
    ...
    bake_t *bake =
      bake_create_from_file("test_data34/bake_postprocess1/Dunefile");
