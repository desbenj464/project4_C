...
bake_t {
  filename = test_data34/bake_postprocess1/Dunefile
  rule_capacity = 4
  rule_count = 3
  rules[ 0] =
    rule_t {
...
* bake_main01
Make a copy of the test_data34/bake_main01 directory, then change into that
...
#+TESTY: test_directory="test-results/bake_main01"
#+TESTY: !cp -r ../../test_data34/bake_main01/* .
...
* bake_main02
Make a copy of the test_data34/bake_main02 directory, then change into that
copy and run bake to analyze and then build the programs according to
...
#+TESTY: test_directory="test-results/bake_main02"
#+TESTY: !cp -r ../../test_data34/bake_main02/* .
...
* bake_main03
An even larger build from test_data34/bake_main03. This test calls bake and
...
#+TESTY: test_directory="test-results/bake_main03"
#+TESTY: !cp -r ../../test_data34/bake_main03/* .
...
* bake_main04
Make a copy of the test_data34/bake_main04 directory, then change into that
...
#+TESTY: test_directory="test-results/bake_main04"
#+TESTY: !cp -r ../../test_data34/bake_main04/* .
...
#+TESTY: test_directory="test-results/bake_main05"
#+TESTY: !cp -r ../../test_data34/bake_main05/* .
...
#+TESTY: test_directory="test-results/bake_main06"
#+TESTY: !cp -r ../../test_data34/bake_main06/* .
...
#+TESTY: test_directory="test-results/bake_main07"
#+TESTY: !cp -r ../../test_data34/bake_main07/* .
...
#+TESTY: test_directory="test-results/bake_main08"
#+TESTY: !cp -r ../../test_data34/bake_main08/* .
...
#+TESTY: test_directory="test-results/bake_main09"
#+TESTY: !cp -r ../../test_data34/bake_main09/* .
...
#+TESTY: test_directory="test-results/bake_main10"
#+TESTY: !cp -r ../../test_data34/bake_main10/* .
