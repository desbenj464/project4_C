...
>> cp -r test_data5/bake_check_cycles01 test-results/
...
>> cp -r test_data5/bake_check_cycles02 test-results/
...
>> cp -r test_data5/bake_check_cycles03 test-results/
...
>> cp -r test_data5/bake_check_cycles04 test-results/
...
bake failed
>> touch -d -1sec fileLR2.txt
>> touch -d -1min fileLR1.txt
>> ../../bake fileLR1.txt
...
#+TESTY: use_valgrind=1
#+TESTY: test_directory="test-results/bake_check_cycles_main_mem1"
#+TESTY: !cp -r ../../test_data5/bake_check_cycles04/* .
