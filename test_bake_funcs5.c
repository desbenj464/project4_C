...
int main(int argc, char *argv[]){
  ...
  IF_TEST("bake_check_cycles_noprint1") { 
    ...
    // bake_check_cycles01
    system("rm -rf test-results/bake_check_cycles01_np");
    system("cp -r test_data5/bake_check_cycles01 test-results/bake_check_cycles01_np");
    chdir("test-results/bake_check_cycles01_np");
    ...
    // bake_check_cycles02
    system("rm -rf test-results/bake_check_cycles02_np");
    system("cp -r test_data5/bake_check_cycles02 test-results/bake_check_cycles02_np");
    chdir("test-results/bake_check_cycles02_np");
    printf("\n--- CONTENTS OF BAKEFILE ---\n");
    system("cat Bakefile");
    bake = bake_create_from_file("Bakefile");
    bake_add_implicit_rules(bake);
    ...
    // bake_check_cycles03
    system("rm -rf test-results/bake_check_cycles03_np");
    system("cp -r test_data5/bake_check_cycles03 test-results/bake_check_cycles03_np");
    chdir("test-results/bake_check_cycles03_np");
    printf("\n--- CONTENTS OF BAKEFILE ---\n");
    system("cat Bakefile");
    bake = bake_create_from_file("Bakefile");
    bake_add_implicit_rules(bake);
    ...
    // bake_check_cycles04
    system("rm -rf test-results/bake_check_cycles04_np");
    system("cp -r test_data5/bake_check_cycles04 test-results/bake_check_cycles04_np");
    chdir("test-results/bake_check_cycles04_np");
    printf("\n--- CONTENTS OF BAKEFILE ---\n");
    system("cat Bakefile");
    bake = bake_create_from_file("Bakefile");
    bake_add_implicit_rules(bake);
    ...
    system("rm -rf test-results/bake_check_cycles_none_np");
    system("cp -r test_data5/bake_check_cycles_none test-results/bake_check_cycles_none_np");
    chdir("test-results/bake_check_cycles_none_np");
    printf("\n--- CONTENTS OF BAKEFILE ---\n");
    system("cat Bakefile");
    bake = bake_create_from_file("Bakefile");
    bake_add_implicit_rules(bake);
  ...
  IF_TEST("bake_check_cycles_print1") { 
    ...
    system("cp -r test_data5/bake_check_cycles01 test-results/");
    ...
    system("cp -r test_data5/bake_check_cycles02 test-results/");
  ...
  IF_TEST("bake_check_cycles_print2") { 
    ...
    system("cp -r test_data5/bake_check_cycles03 test-results/");
    ...
    system("cp -r test_data5/bake_check_cycles04 test-results/");
