...
int main(int argc, char *argv[]){
  ...
  IF_TEST("bake_add_empty_rule1") { 
    ...
    printf("BAKEFILE CONTENTS\n");
    system("cat test_data12/Bakefile1");
    bake_t *bake = bake_create_from_file("test_data12/Bakefile1"); // 1 rule
  ...
  IF_TEST("bake_add_empty_rule2") { 
    ...
    printf("BAKEFILE CONTENTS\n");
    system("cat test_data12/Bakefile2");
    bake_t *bake = bake_create_from_file("test_data12/Bakefile2"); // 3 rules
    rule_t *new_rule;
  ...
  IF_TEST("bake_add_implicit_rules1") { 
    ...
    system("cat test_data12/BakeImplicit1");
    bake_t *bake = bake_create_from_file("test_data12/BakeImplicit1");
  ...
  IF_TEST("bake_add_implicit_rules2") { 
    ...
    printf("ORIGINAL FILE\n");
    system("cat test_data12/BakeImplicit2");
    bake_t *bake = bake_create_from_file("test_data12/BakeImplicit2");
    bake_add_implicit_rules(bake);
    printf("\nAFTER bake_add_implicit_rules()\n");
    bake_show_bake(bake,0);
    bake_free(bake);
  ...
  IF_TEST("bake_add_implicit_rules3") { 
    ...
    // implicit rules.
    printf("ORIGINAL FILE\n");
    system("cat test_data12/BakeImplicit3");
    bake_t *bake = bake_create_from_file("test_data12/BakeImplicit3");
    bake_add_implicit_rules(bake);
    printf("\nAFTER bake_add_implicit_rules()\n");
    bake_show_bake(bake,0);
    bake_free(bake);
  ...
  IF_TEST("bake_execute_cmd3") { 
    // Checks that simple command excutions works correctly
    cmd_t cmd = {
      .tokens = {"wc","-l","test_data12/randnums.txt",
                 "test_data12/randnums50.txt","test_data12/gettysburg.txt"},
      .input_redirect  = NULL,
      .output_redirect = NULL,
      .line_number = 0,
      .cmd_flags = 0,
  ...
  IF_TEST("bake_execute_cmd_in1") { 
    ...
    cmd_t cmd = {
      .tokens = {"wc","-w","-c"},
      .input_redirect  = "test_data12/gettysburg.txt",
      .output_redirect = NULL,
      .line_number = 0,
      .cmd_flags = CMD_INPREDI_BIT,
    };
  ...
  IF_TEST("bake_execute_cmd_out1") { 
    ...
    cmd_t cmd = {
      .tokens = {"wc","test_data12/gettysburg.txt"},
      .input_redirect  = NULL,
  ...
  IF_TEST("bake_execute_cmd_inout1") { 
    ...
    cmd_t cmd = {
      ...
      .input_redirect  = "test_data12/gettysburg1.txt",
  ...
  IF_TEST("bake_execute_cmd_fail1") { 
    ...
    cmd_t cmd = {
      .tokens = {"ls","test_data12/no-such-file.txt"},
      .input_redirect  = NULL,
      .output_redirect = NULL,
      .line_number = 0,
      .cmd_flags = 0,
  ...
  IF_TEST("bake_execute_cmd_fail3") { 
    ...
    cmd_t cmd = {
      .tokens = {"wc"},
      .input_redirect  = "test_data12/no-such-file.txt", // open() will fail
      .output_redirect = NULL,
      .line_number = 0,
      .cmd_flags = CMD_INPREDI_BIT,
    };
