...
---OUTPUT---
wc -l test_data12/randnums.txt test_data12/randnums50.txt test_data12/gettysburg.txt 
   2 test_data12/randnums.txt
  50 test_data12/randnums50.txt
  32 test_data12/gettysburg.txt
  84 total
ret: 0
#+END_SRC
...
---OUTPUT---
wc -w -c < test_data12/gettysburg.txt 
 283 1511
ret: 0
#+END_SRC
...
---OUTPUT---
wc test_data12/gettysburg.txt > test-results/cmd_out1.txt 
ret: 0
FILE CONTENTS
  32  283 1511 test_data12/gettysburg.txt
#+END_SRC
...
---OUTPUT---
sed s/f/p/g; s/F/P/g < test_data12/gettysburg1.txt > test-results/cmd_inout1.txt 
ret: 0
FILE CONTENTS
...
---OUTPUT---
ls test_data12/no-such-file.txt 
ls: cannot access test_data12/no-such-file.txt: No such file or directory
ret: 2
#+END_SRC
...
---OUTPUT---
wc < test_data12/no-such-file.txt 
